...
class BobClient:
    ...
    def make_request(self, method, endpoint, json_body=None, query=None, body=None, files=None):
        ...
        response = request(endpoint, auth=HTTPBasicAuth(self.service_account_id, self.service_account_token), **request_params)
    ...
    def get(self, endpoint, query=None, json_body=None, body=None):
        return self.make_request('GET', endpoint, query=query, json_body=json_body, body=body)
    ...
    def put(self, endpoint, json_body=None, query=None, body=None, files=None):
        return self.make_request('PUT', endpoint, json_body=json_body, query=query, body=body, files=files)

    def delete(self, endpoint, json_body=None, query=None, body=None, files=None):
        return self.make_request('DELETE', endpoint, json_body=json_body, query=query, body=body, files=files)