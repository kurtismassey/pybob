...
class Tables(BobEndpoint):
    def read_all_entries(self, employeeId: str, customTableId: str, includeHumanReadable: Optional[bool] = None):
        """
        ...
        return self.client.get(
            f'people/custom-tables/{employeeId}/{customTableId}',
            query=query
        )
    
    def create_custom_table_entry(self, employeeId: str, customTableId: str, rawBody: Optional[str] = None):
        """
    ...
    def update_custom_table_entry(self, employeeId: str, customTableId: str, entryId: str, rawBody: Optional[str] = None):
        """
    ...
    def delete_custom_table_entry(self, employeeId: str, customTableId: str, entryId: str) -> dict:
        """
