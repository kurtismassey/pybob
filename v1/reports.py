...
class Reports(BobEndpoint):
    ...
    def download(self, reportId: int, format: str, includeInfo: Optional[bool] = False, locale: Optional[str] = None, humanReadable: Optional[str] = None):
        """
        ...
        return self.client.get(
            f"company/reports/{reportId}/download", 
            query=query
            )
    
    def get_report_download_url(self, reportId: int, format: str, includeInfo: bool = False, locale: Optional[str] = None, humanReadable: Optional[str] = None):
        """
        ...
        response = self.client.get(
            f"company/reports/{reportId}/download-async",
            query=query
        )
    ...
    def download_report_by_url(self, reportName: str):
        ...
        return self.client.get(
            f"company/reports/download/{reportName}"
        )