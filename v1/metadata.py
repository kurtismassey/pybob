...
class Lists(BobEndpoint):
    def get(self, listName: Optional[str] = None, includeArchived: Optional[bool] = None) -> dict:
        """
    ...
    def add_item(self, listName: str, name: str, parentId: Optional[str] = None) -> dict:
        """
        ...
        return self.client.post(
            f"company/named-lists/{listName}",
            json_body=json_body
        )
    
    def update_item(self, listName: str, itemId: str, name: Optional[str] = None, parentId: Optional[str] = None):
        """
        ...
        return self.client.put(
            f"company/named-lists/{listName}/{itemId}",
            json_body=json_body
        )
...
class Fields(BobEndpoint):
    ...
    def create_field(self, name: str, category: str, type: str, description: Optional[str] = None, historical: Optional[str] = None):
        """
        Create a new field.
        ...
        field = BobField(name=name, category=category, type=type.lower(), description=description, historical=historical)
    ...
    def update_field(self, fieldId: str, name: Optional[str] = None, description: Optional[str] = None):
        """
        ...
        return self.client.put(
            f"company/people/fields/{fieldId}",
            json_body=json_body
        )
